...
public class UserResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<User> findById(@PathVariable Long id) { //Pra ser reconhecido com variável da URL, @PathVariable
	...
	public ResponseEntity<Void> delete(@PathVariable Long id) { //Não retorna nenhum corpo. Só exclui.
		service.delete(id);
		return ResponseEntity.noContent().build(); //Sem conteúdo
	}
}